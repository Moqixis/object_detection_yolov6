...
def get_args_parser(add_help=True):
    ...
    # 修改输出路径
    parser.add_argument('--output-dir', default='/data/models/lhq/yolov6/train', type=str, help='path to save outputs')
    # 修改输出路径-exp
    parser.add_argument('--name', default='exp5', type=str, help='experiment name, saved to output_dir/name')
