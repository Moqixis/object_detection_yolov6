...
def get_args_parser(add_help=True):
    ...
    # 修改模型路径
    parser.add_argument('--weights', type=str, default='/data/models/lhq/yolov6/train/yolov6_s/weights_50/best_ckpt.pt', help='model.pt path(s)')
    ...
    # 修改存储路径
    parser.add_argument('--save_dir', type=str, default='/data/dataset/lhq/yolov6/val/', help='evaluation save dir')
