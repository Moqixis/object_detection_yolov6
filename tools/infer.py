...
def get_args_parser(add_help=True):
    ...
    # 修改模型路径
    parser.add_argument('--weights', type=str, default='/data/models/lhq/yolov6/train/exp2/weights/best_ckpt.pt', help='model path(s) for inference.')
    # 修改待检测数据路径
    parser.add_argument('--source', type=str, default='/data/dataset/lhq/test/VOCdevkit/VOC2007/JPEGImages', help='the source path, e.g. image-file/dir.')
    # parser.add_argument('--source', type=str, default='/data/dataset/lhq/SINet/DataSet/TestDataset/04130101/Image', help='the source path, e.g. image-file/dir.')
    # 修改数据路径
    ...
    parser.add_argument('--iou-thres', type=float, default=0.6, help='NMS IoU threshold for inference.')
    ...
    # 修改存储路径
    parser.add_argument('--project', default='/data/dataset/lhq/yolov6/inference', help='save inference results to project/name.')
    # 修改存储路径
    parser.add_argument('--name', default='0209n50', help='save inference results to project/name.')
